...
public class SelectUserBaseAdapter extends RecyclerView.Adapter<SelectUserBaseAdapter.MyViewHolder> {
    ...
    public SelectUserBaseAdapter(ArrayList<User> users) {
        this.users = users;
    }
            ...
            public void onClick(View view) {
                ...
                if (myViewHolder.checked == false) {
                    ...
                    for (int i = 0; i < selectedUsers.size(); i++) {
                        if (selectedUsers.get(i).getId() == myViewHolder.user.getId()) {
                            selectedUsers.remove(selectedUsers.get(i));
                            break;
                        }
                    }
