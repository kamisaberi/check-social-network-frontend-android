...
final class ChipOptions {
    ...
    boolean mHideKeyboardOnDoneClick;
    int mMaxRows;
    String mDelimiter;
    ...
    ChipOptions(Context c, AttributeSet attrs, int defStyleAttr) {
        ...
        mHideKeyboardOnChipClick = a.getBoolean(R.styleable.ChipsInputLayout_hideKeyboardOnChipClick, false);
        mHideKeyboardOnDoneClick = a.getBoolean(R.styleable.ChipsInputLayout_hideKeyboardOnDoneClick, false);
        mMaxRows = a.getInt(R.styleable.ChipsInputLayout_maxRows, 5);
